...
"Copyright &copy; 2011-YYYY The BitfxCoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About BitfxCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>BitfxCoin</b> version", 0));
